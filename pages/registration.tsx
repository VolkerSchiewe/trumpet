            ...
            <GoogleReCaptchaProvider reCaptchaKey={process.env.RECAPTCHA_KEY}>
                <div className="w-full max-w-2xl m-auto">
                    <div className='flex justify-end items-start mt-5'>
                        <svg className='h-8 w-8 text-blue-dark cursor-pointer' fill="currentColor" viewBox="0 0 20 20" aria-label={"Zurück"}
                             onClick={() => router.push("/")}>
                        ...
                        <img className="w-1/3 mx-2" src={"images/headline-black.svg"}
                             alt={"Brüderischer Bläsertag 2021 Berlin"}/>
                        <Logo className="w-1/5 mx-2"/>
                    </div>
