...
const Layout: React.FC<Props> = ({children, disableGutters, title = 'Brüderischer Bläsertag 2021 Berlin'}) => (
    <div className='flex flex-col' style={{
        ...
        <Container className='flex flex-col mb-5' maxWidth={'xl'} disableGutters={disableGutters}>
            {children || ''}
        </Container>
