...
export const checkRegistration = europeFunctions.https.onRequest(registration(admin));
export const emailVerificationHandler = europeFunctions.https.onRequest(verifyEmail(admin));
