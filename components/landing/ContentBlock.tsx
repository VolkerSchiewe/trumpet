...
const ContentBlock: React.FC<Props> = ({color, title, content}) => {
    return (
        <div className={`border-${color} text-${color} hover:text-white hover:bg-${color} border p-5 transform hover:scale-105 transition-all duration-300 ease-in-out hover:shadow-2xl`}>
